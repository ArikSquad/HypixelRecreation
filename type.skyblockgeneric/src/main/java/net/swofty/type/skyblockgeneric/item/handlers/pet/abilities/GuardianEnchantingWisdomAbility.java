...
public final class GuardianEnchantingWisdomAbility implements PetAbility {
    private static final RarityValue<Double> WISDOM_PER_LEVEL = new RarityValue<>(
            0.0, 0.0, 0.25, 0.30, 0.30, 0.30, 0.0);
